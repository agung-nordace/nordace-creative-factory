...
export async function POST(request: NextRequest) {
  try {
    ...
    for (
      ...
      const rows = creatives
        ...
        .map((creative: any) => {
          ...
          return {
            ...
            // Temporary candidate.
            // We validate it against public.sprints below.
            sprint_id: possibleSprintId,

            // Resolved from sprint after validation.
      ...
      // =======================================================
      // 5. VALIDATE SPRINT IDs + RESOLVE TEAM IDs
      // =======================================================
      ...
      // =======================================================
      // 8. SAVE PROGRESS AFTER EVERY PAGE
      // =======================================================
    ...
    // =========================================================
    // 9. COMPLETE OR PAUSE FOR NEXT RUN
    // =========================================================
