  ...
  return (
    <main className="page">
      ...
      <style jsx>{`
        ...
        .eyebrow { color:#2563eb; font-size:11px; font-weight: 700; letter-spacing:.1em; }
        h1 { margin:6px 0 6px; font-size:31px; }
        h2 { margin:0; }
        p { color:#64748b; line-height:1.5; }
        .back { height:fit-content; text-decoration:none; border:1px solid #cbd5e1; background:white; color:#334155; padding:10px 13px; border-radius:8px; font-size:12px; font-weight: 700; }
        ...
        .panelLabel,.quickLabel { color:#64748b; font-size:10px; font-weight: 700; letter-spacing:.08em; }
        ...
        .sectionTitle > span { display:grid; place-items:center; width:25px; height:25px; border-radius:50%; background:#2563eb; color:white; font-size:12px; font-weight: 700; }
        ...
        .generateButton { width:100%; min-height:44px; border:0; border-radius:8px; background:#2563eb; color:white; font-weight: 700; cursor:pointer; }
        ...
        .resultActions a,.resultActions button { min-height:38px; display:flex; align-items:center; justify-content:center; text-decoration:none; border:1px solid #cbd5e1; background:white; color:#334155; border-radius:7px; font-size:11px; font-weight: 700; }
