  ...
  return (
    <main className="page">
      ...
      <style jsx>{`
        ...
        .miniLabel { color:#64748b; font-size:10px; font-weight: 700; letter-spacing:.08em; }
        ...
        .sectionTitle > span { display:grid; place-items:center; width:25px; height:25px; background:#2563eb; color:white; border-radius:50%; font-size:12px; font-weight: 700; }
        ...
        .ratioCard small { margin-top:12px; font-size:10px; font-weight: 700; color:#2563eb; }
        ...
        .actions a { text-align:center; padding:8px; border:1px solid #cbd5e1; border-radius:7px; text-decoration:none; color:#334155; font-size:11px; font-weight: 700; }
